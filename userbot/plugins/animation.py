...
import random
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "Buzz User"

@borg.on(admin_cmd(pattern="bodo$"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(admin_cmd(pattern=f"buzz$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@borg.on(admin_cmd(pattern=f"monyet$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 2
...
@borg.on(admin_cmd(pattern=f"perangkat$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 2
...
@borg.on(admin_cmd(pattern=f"jari$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@borg.on(admin_cmd(pattern=f"sos$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@borg.on(admin_cmd(pattern=f"manusia$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.5
